...
export class PartidosService {
  private readonly api = `http://localhost:5082/api/admin/partidos`;
  private readonly apiEquipos = `http://localhost:5081/api/equipos`;
  private readonly apiJugadores = `http://localhost:5081/api/jugadores`;
